#include "shell.h"
/**
 * splitStringPath - funxtion to tokenize the path of enviroment
 * @arguments: Is String of the Env to Path
 * @argvs: arguments input in our shell to concatenate with PATH
 * Return: A double pointer(Matriz) with PATH & command type concatenate
 */
